...
video_path = "../static/videos/bear_edit_bg.mp4"  # Replace with your video file path
output_video_path = "../static/videos/bear_edit_bg_text.mp4"  # Replace with your output video file path
...
texts = ["Identity", "add cactuses", "make it winter", "in a cave"]
for text in texts:
    font = 'Arial' if text == "Identity" else 'Apple-Chancery'
    text_clip = TextClip(text, fontsize=fontsize, font=font, color=text_color, bg_color=bg_color, size=(video.w / len(texts), padding_height))
...
offsets = [0, 1000, 2000, 3000]  # Adjust these values to disturb horizontally
